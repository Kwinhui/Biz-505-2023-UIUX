...
document.addEventListener("DOMContentLoaded", () => {
  ...
  ulContent.addEventListener("click", (event) => {
    ...
    if (target.tagName === "SPAN") {
      ...
      /**
       * target.closest("LI")
       * 클릭된 요소(target = span)를 감싸고 있는 부모들 중에
       * 가장 가까이 있는 LI tag
       */
      ...
      /**
       * tag 요소에 class 속성이 설정되면 classList 에 해당 class명이
       * 배열로 저장되어 있다.
